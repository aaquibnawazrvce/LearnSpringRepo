...
var webColumns=[
	{
		...
		width    :130
		},
         			{
         				...
         				dataIndex : 'thLevelEncryptMedicalInfoSummary',
         				sortable:true,
         				width:240,
         			...
         			},
         			{
         				...
         				dataIndex : 'thLevelEncryptMedicalTreatmentDetails',
         				sortable:true,
         				width    :240,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
					...
					{
         				header : 'Doctor Name',
         				dataIndex : 'thLevelEncryptDoctorName',
         				sortable:true,
         				width    :130,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
         			...
         			},
					{
         				...
         				dataIndex : 'thLevelEncryptClinicHospitalName',
         				sortable:true,
         				width    :130,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
         				...
         				dataIndex : 'thLevelEncryptMedicalInfoId',
         				sortable:true,
         				width    :130,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
