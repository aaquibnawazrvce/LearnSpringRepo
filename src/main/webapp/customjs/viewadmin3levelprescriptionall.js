...
var webColumns=[
						...
						},
         			{
         				...
         				dataIndex : 'thEncPrescriptionInfoSummary',
         				sortable:true,
         				width:240,
         			...
         			},
         			{
         				...
         				dataIndex : 'thEncPrescriptionTreatmentDetails',
         				sortable:true,
         				width    :200,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
         			...
         			},
					{
         				...
         				dataIndex : 'thEncClinicHospitalName',
         				sortable:true,
         				width    :180,
         				renderer : function(value, metadata, record, rowIndex, colIndex, store) {
         					metadata.tdAttr = 'data-qtip="' + value + '"';
