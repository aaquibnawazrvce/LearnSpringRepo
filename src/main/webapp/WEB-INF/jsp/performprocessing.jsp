...
<script
	src="<%=request.getContextPath()%>/customjs/performprocessing.js"></script>
...
<body>
	...
	<div class="container" ng-app="processingApp" id="contentContainer">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div ng-controller="processingAppController"
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							...
							<button type="submit" class="productBtn"
								ng-disabled="data_submission" ng-click="perform_processing()">Data
								Processing</button>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<a class="productBtn"
								href="<%=request.getContextPath()%>/adminPage">Admin</a>
						</div>
